({
  onLoad() {
    ...
    function injectSilent(chId, m) { try { if(!FinalDispatcher)return; FinalDispatcher.dispatch({type:"MESSAGE_UPDATE",message:prep(m)}); } catch(e){ try{inject(chId,m);}catch(e2){} } }
